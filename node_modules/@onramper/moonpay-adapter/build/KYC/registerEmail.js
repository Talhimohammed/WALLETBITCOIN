...
function default_1(id, amount, fiatCurrency, cryptoCurrency, paymentMethod, onramperApiKey, email, cryptocurrencyAddress, cryptocurrencyAddressTag, country) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (validateAddress_1.default(cryptocurrencyAddress, cryptoCurrency) === false) {
        ...
        sendWaypoint_1.default(id, onramperApiKey, "email", Object.assign(Object.assign({}, record), { email: yield hash_1.default(email) }));
        const termsOfUse = {
            type: "boolean",
            name: "termsOfUse",
            terms: [
