...
function default_1(txId, ccTokenId) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const partnerContext = index_1.getPartnerContext()
                ? `${JSON.stringify(index_1.getPartnerContext())}`
                : "";
            const moonpayTx = (yield fetch_1.default(`${constants_1.moonpayBaseAPI}/transactions`, {
                ...
                body: JSON.stringify({
                    ...
                    tokenId: ccTokenId,
                    externalTransactionId: token_1.encodeToken([
                        txId,
                        creationTx.apiKey,
                        partnerContext,
                    ]),
            ...
            sendWaypoint_1.default(txId, creationTx.apiKey, "registerCreditCardToken", {
                status: moonpayTx.status,
            });
